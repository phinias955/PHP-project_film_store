    ...
    ?>
            <div class="row">
                <tr>
                    ...
                    <td><button type="submit" class="btn btn-success"><a href="mangeActiv.php?active=<?php echo $rows['email'] ?>" class="text-white">ACTIVET</a> </button></td>
                    <td><button type="submit" class="btn btn-primary"><a href="manangedeac.php?deactive=<?php echo $rows['email'] ?>" class="text-white">DiACTIVE</a></button></td>
                </tr>
            </div>
    <?php
        }
