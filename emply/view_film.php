...
<table class="table table-stripe" style="width:90%; margin-top: 2%;" id="example">
    ...
    if (isset($_POST['serch'])) {
        ...
        if (!empty(trim($data))) {
            ...
            $sql2 = "SELECT * FROM `film` WHERE FilmId='$data' OR Title='$data' OR producer='$data' OR theme='$data'OR year_prod='$data' OR price='$data'";
    ...
    ?>
                    <div class="row">
                        <tr>
                            ...
                            <td><button type="submit" class="btn btn-success"><a href="acitive.php?active=<?php echo $rows['FilmId'] ?>" class="text-white">ACTIVET</a> </button></td>
